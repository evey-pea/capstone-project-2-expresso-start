...
describe("Employee Table", function () {
  ...
  it("should have name, position, wage, and is_current_employee columns with appropriate data types", function (done) {
    prodDb.run(
      "INSERT INTO Employee (name, position, wage, is_current_employee) VALUES ('Employee Name', 'Employee', 10.5, 1)",
      function (error) {
        if (error) {
          done(new Error(error));
        } else {
          prodDb.run(
            `DELETE FROM Employee WHERE Employee.id = ${this.lastID}`,
            () => {
  ...
  it("should have a required name column", function (done) {
    prodDb.run(
      "INSERT INTO Employee (position, wage, is_current_employee) VALUES ('Employee', 10.5, 1)",
      function (error) {
  ...
  it("should have a required position column", function (done) {
    prodDb.run(
      "INSERT INTO Employee (name, wage, is_current_employee) VALUES ('Employee Name', 10.5, 1)",
      function (error) {
        if (error && error.toString().includes("NOT NULL constraint failed")) {
          done();
        } else if (!error) {
  ...
  it("should have a required wage column", function (done) {
    prodDb.run(
      "INSERT INTO Employee (name, position, is_current_employee) VALUES ('Employee Name', 'Employee', 1)",
      function (error) {
        if (error && error.toString().includes("NOT NULL constraint failed")) {
          done();
        } else if (!error) {
  ...
  it("is_current_employee should default to 1", function (done) {
    prodDb.run(
      "INSERT INTO Employee (name, position, wage) VALUES ('Employee Name', 'Employee', 10.5)",
      function (error) {
        if (error) {
          done(new Error(error));
        } else {
...
describe("Timesheet Table", function () {
  ...
  it("should have hours, rate, date, and employee_id columns with appropriate data types", function (done) {
    prodDb.run(
      "INSERT INTO Timesheet (hours, rate, date, employee_id) VALUES (10, 2.5, 1506112351471, 1)",
      function (error) {
        if (error) {
          done(new Error(error));
        } else {
          prodDb.run(
            `DELETE FROM Timesheet WHERE Timesheet.id = ${this.lastID}`,
            () => {
              expect(this.lastID).to.exist;
              done();
            }
  ...
  it("should have a required hours column", function (done) {
    prodDb.run(
      "INSERT INTO Timesheet (rate, date, employee_id) VALUES (2.5, 1506112351471, 1)",
      function (error) {
        if (error && error.toString().includes("NOT NULL constraint failed")) {
          done();
        } else if (!error) {
  ...
  it("should have a required rate column", function (done) {
    prodDb.run(
      "INSERT INTO Timesheet (hours, date, employee_id) VALUES (10, 1506112351471, 1)",
      function (error) {
        if (error && error.toString().includes("NOT NULL constraint failed")) {
          done();
        } else if (!error) {
  ...
  it("should have a required date column", function (done) {
    prodDb.run(
      "INSERT INTO Timesheet (hours, rate, employee_id) VALUES (10, 2.5, 1)",
      function (error) {
        if (error && error.toString().includes("NOT NULL constraint failed")) {
          done();
        } else if (!error) {
  ...
  it("should have a required employee_id column", function (done) {
    prodDb.run(
      "INSERT INTO Timesheet (hours, rate, date) VALUES (10, 2.5, 1506112351471)",
      function (error) {
        if (error && error.toString().includes("NOT NULL constraint failed")) {
          done();
        } else if (!error) {
...
describe("Menu Table", function () {
  ...
  it("should have id and title columns with appropriate data types", function (done) {
    prodDb.run(
      "INSERT INTO Menu (title) VALUES ('Menu Title')",
      function (error) {
        if (error) {
          done(new Error(error));
        } else {
...
describe("MenuItem Table", function () {
  ...
  it("should have id, name, description, inventory, price, and menu_id columns with appropriate data types", function (done) {
    prodDb.run(
      "INSERT INTO MenuItem (name, description, inventory, price, menu_id) VALUES ('MenuItem Name', 'MenuItem Description', 10, 1.5, 1)",
      function (error) {
        if (error) {
          done(new Error(error));
        } else {
          prodDb.run(
            `DELETE FROM MenuItem WHERE MenuItem.id = ${this.lastID}`,
            () => {
              expect(this.lastID).to.exist;
              done();
            }
  ...
  it("should have a required name column", function (done) {
    prodDb.run(
      "INSERT INTO MenuItem (description, inventory, price, menu_id) VALUES ('MenuItem Description', 10, 1.5, 1)",
      function (error) {
        if (error && error.toString().includes("NOT NULL constraint failed")) {
          done();
        } else if (!error) {
  ...
  it("should have a required inventory column", function (done) {
    prodDb.run(
      "INSERT INTO MenuItem (name, description, price, menu_id) VALUES ('MenuItem Name', 'MenuItem Description', 1.5, 1)",
      function (error) {
        if (error && error.toString().includes("NOT NULL constraint failed")) {
          done();
        } else if (!error) {
  ...
  it("should have a required price column", function (done) {
    prodDb.run(
      "INSERT INTO MenuItem (name, description, inventory, menu_id) VALUES ('MenuItem Name', 'MenuItem Description', 10, 1)",
      function (error) {
        if (error && error.toString().includes("NOT NULL constraint failed")) {
          done();
        } else if (!error) {
  ...
  it("should have a required menu_id column", function (done) {
    prodDb.run(
      "INSERT INTO MenuItem (name, description, inventory, price) VALUES ('MenuItem Name', 'MenuItem Description', 10, 1.5)",
      function (error) {
        if (error && error.toString().includes("NOT NULL constraint failed")) {
          done();
        } else if (!error) {
...
describe("GET /api/employees/:id", function () {
  ...
  it("should return a 200 status code for valid IDs", function () {
    return request(app).get("/api/employees/2").expect(200);
  });

  it("should return a 404 status code for invalid IDs", function () {
    return request(app).get("/api/employees/999").expect(404);
  });
});
      ...
      .then(function () {
        testDb.all("SELECT * FROM employee", function (error, result) {
          const employee = result.find(
            (employee) => employee.name === newEmployee.name
          );
...
describe("DELETE /api/employees/:id", function () {
  ...
  it("should return a 200 status code after employee delete", function () {
    return request(app).del("/api/employees/1").expect(200);
  });
...
describe("GET /api/employees/:employeeId/timesheets", function () {
  ...
  it("should return a status code of 200 for valid employees", function () {
    return request(app).get("/api/employees/2/timesheets").expect(200);
  });

  it("should return a status code of 404 for invalid employees", function () {
    return request(app).get("/api/employees/999/timesheets").expect(404);
  });
});
    ...
    return request(app)
      ...
      .then(function () {
        testDb.all("SELECT * FROM timesheet", function (error, result) {
          const timesheet = result.find(
            (timesheet) => timesheet.date === newTimesheet.date
          );
...
describe("PUT /api/employees/:employeeId/timesheets/:timesheetId", function () {
  ...
  it("should update the timesheet with the given ID", function (done) {
    request(app)
      ...
      .then(function () {
        testDb.get(
          "SELECT * FROM timesheet WHERE timesheet.id = 2",
...
describe("DELETE /api/employees/:employeeId/timesheets/:timesheetId", function () {
  ...
  it("should remove the timesheet with the specified ID from the database", function (done) {
    request(app)
      ...
      .then(function () {
        testDb.get(
          "SELECT * FROM timesheet WHERE timesheet.id = 1",
          function (error, timesheet) {
            if (error) {
              throw new Error(error);
            }
  ...
  it("should return a 204 status code after timesheet delete", function () {
    return request(app).del("/api/employees/2/timesheets/1").expect(204);
  });

  it("should return a 404 status code for invalid timesheet IDs", function () {
    return request(app).del("/api/employees/2/timesheets/999").expect(404);
  });
});
...
describe("GET /api/menus", function () {
  ...
  it("should return a status code of 200", function () {
    return request(app).get("/api/menus").expect(200);
  });
});
...
describe("GET /api/menus/:id", function () {
  ...
  it("should return a 200 status code for valid IDs", function () {
    return request(app).get("/api/menus/2").expect(200);
  });

  it("should return a 404 status code for invalid IDs", function () {
    return request(app).get("/api/menus/999").expect(404);
  });
});
...
describe("POST /api/menus", function () {
  ...
  it("should return a 201 status code after menu creation", function () {
    return request(app).post("/api/menus/").send({ menu: newMenu }).expect(201);
  });
  ...
  it("should return a 400 status code for invalid menus", function () {
    return request(app).post("/api/menus/").send({ menu: {} }).expect(400);
  });
});
...
describe("PUT /api/menus/:id", function () {
  ...
  it("should update the menu with the given ID", function (done) {
    request(app)
      ...
      .then(function () {
        testDb.get(
          "SELECT * FROM Menu WHERE Menu.id = 2",
          function (error, menu) {
            if (error) {
              throw new Error(error);
            }
  ...
  it("should return a 400 status code for invalid menu updates", function () {
    return request(app).put("/api/menus/1").send({ menu: {} }).expect(400);
  });
});
...
describe("DELETE /api/menus/:id", function () {
  ...
  it("should remove the menu with the specified ID from the database if that menu has no related menu items", function (done) {
    request(app)
      ...
      .then(function () {
        testDb.get(
          "SELECT * FROM Menu WHERE Menu.id = 3",
          function (error, menu) {
            if (error) {
              throw new Error(error);
            }
  ...
  it("should return a 204 status code after menu delete", function () {
    return request(app).del("/api/menus/3").expect(204);
  });
  ...
  it("should return a 400 status code if deleted menu has existing related menu items", function () {
    return request(app).del("/api/menus/2").expect(400);
  });
});
...
describe("GET /api/menus/:menuId/menu-items", function () {
  ...
  it("should return a status code of 200 for valid menus", function () {
    return request(app).get("/api/menus/2/menu-items").expect(200);
  });

  it("should return a status code of 404 for invalid menus", function () {
    return request(app).get("/api/menus/999/menu-items").expect(404);
  });
});
      ...
      .then(function () {
        testDb.all("SELECT * FROM menuItem", function (error, result) {
          const menuItem = result.find(
            (menuItem) => menuItem.name === newMenuItem.name
          );
...
describe("PUT /api/menus/:menuId/menu-items/:menuItemId", function () {
  ...
  it("should update the menu item with the given ID", function (done) {
    request(app)
      ...
      .then(function () {
        testDb.get(
          "SELECT * FROM MenuItem WHERE MenuItem.id = 2",
...
describe("DELETE /api/menus/:menuId/menu-items/:menuItemId", function () {
  ...
  it("should return a 204 status code after menu item delete", function () {
    return request(app).del("/api/menus/1/menu-items/2").expect(204);
  });

  it("should return a 404 status code for invalid menu item IDs", function () {
    return request(app).del("/api/menus/1/menu-items/999").expect(404);
  });
});
